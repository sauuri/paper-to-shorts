...
_JSON_SCHEMA = """{
  ...
  "points": [
    "2026년 3월, 서울 강남구에서 대규모 투자 사기가 발생했다",
    "전직 금융사 임원 출신이 주범으로, 치밀하게 피해자를 모았다",
    "피해자만 300명, 총 피해액은 100억 원에 달했다",
    "검거 당시 그는 이미 해외 도피 직전 상태였다",
    "현재까지 회수된 피해금은 전체의 5%에 불과하다"
  ],
...
② 육하원칙 필수: 포인트는 언제·어디서·누가·무엇을·어떻게·왜를 자연스러운 완성 문장으로 담을 것. "언제:", "결과:", "현재:" 같은 레이블 절대 금지
...
③ 육하원칙(언제·어디서·누가·무엇을·어떻게·왜)을 자연스러운 완성 문장으로 담을 것. 레이블 금지
